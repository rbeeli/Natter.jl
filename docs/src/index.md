...
Natter.jl is a Julia client for [NATS](https://nats.io). It provides a synchronous, ergonomic public API while using Julia tasks internally for the reader loop, pings, reconnects, and subscription callbacks.
