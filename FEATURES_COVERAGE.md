...
| Feature | Status | Notes |
|---|---:|---|
| Token auth | Supported | URL or option. Option tokens are stored in redacted mutable buffers, and token values are redacted from `ConnectOptions` display including URL userinfo. |
