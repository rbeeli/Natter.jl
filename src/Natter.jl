...
const DEFAULT_REQUEST_TIMEOUT = 5.0
const DEFAULT_FLUSH_TIMEOUT = 15.0
const DEFAULT_JETSTREAM_TIMEOUT = 10.0
const DEFAULT_ACK_SYNC_TIMEOUT = 5.0
const DEFAULT_READ_BUFFER_SIZE = 64 * 1024
const DEFAULT_WRITE_BUFFER_SIZE = 32 * 1024
const DEFAULT_WRITE_TIMEOUT = 30.0
const DEFAULT_DRAIN_TIMEOUT = 60.0
const DEFAULT_CLOSE_TIMEOUT = 10.0
const DEFAULT_CLOSE_CALLBACK_TIMEOUT = 10.0
